...
{
    //  PolyHedraElementInstanceData
    public struct PHEIData
    {
        public const int Size = Transformation3D.Size + ColorUData.Size + LInterData.Size + LInterData.Size;
        ...
        public PHEIData(Transformation3D trans)
        {
            Trans = trans;
        ...
        public PHEIData(Transformation3D trans, ColorUData altColor, LInterData altColorLInter)
        {
            Trans = trans;
            AltColor = altColor;
